\begin{figure}[h]
  ...
  \begin{minipage}{\textwidth}
    \caption{%
      ...
      \footnotesize
      Rightmost strips of right-column plots include replicates that ended after fixed-duration with a mixture of non- and mutator genotypes.
      ...
      Top panel, \ref{fig:spatial-structure-1d-uncropped:5050}, reports experiments initialized with an even mix of mutator and nonmutator agents.
      In bottom panel, \ref{fig:spatial-structure-1d-uncropped:denovo}, mutators are initially absent and arise spontaneously \textit{de novo} with probability $10^{-6}$.
